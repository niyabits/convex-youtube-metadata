...
The component uses [Google "API Keys"](https://developers.google.com/youtube/registering_an_application).
You must create the API key from the Google API Console.
It is recommended to add API and Application Restrictions to prevent malicious usage.
...
# Convex Convex Youtube Metadata

[![npm version](https://badge.fury.io/js/@example%2Fconvex-youtube-metadata.svg)](https://badge.fury.io/js/@example%2Fconvex-youtube-metadata)
...
[File it here](https://github.com/niyabits/convex-youtube-metadata/issues).
